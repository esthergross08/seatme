  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-16">
      ...
      <Section title="Overview">
        <p>
          SeatMe is a seating-planner tool for events, built and operated by Esther Gross. This policy explains what
          information SeatMe collects, why, and how it&apos;s used. SeatMe is a small, independently run tool —
          there are no advertisers, no data brokers, and nothing here is sold to anyone.
        </p>
      </Section>
      ...
      <Section title="Information we collect">
        ...
        <p>
          ...
          Pinterest board) is sent to Anthropic&apos;s Claude API to generate a response. This is only sent when you
      ...
      <Section title="Who we share information with">
        <p>SeatMe relies on a small number of service providers to operate:</p>
      ...
      <Section title="A note about guest data">
        <p>
          ...
          only enter information about your guests that you have a reasonable basis to use for planning your event.
          If you&apos;re a guest and have questions about information a host has entered about you in SeatMe, please
          reach out to the host directly, or contact us using the details below.
        </p>
      </Section>
